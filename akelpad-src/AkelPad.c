...
#pragma warning(default: 4996)
  ...
  //Codepage
  moInit.nDefaultCodePage=CP_UNICODE_UTF8;
  moInit.bDefaultBOM=TRUE;
  moInit.nNewFileCodePage=CP_UNICODE_UTF8;
  moInit.bNewFileBOM=TRUE;
  ...
  fdInit.nTabStopSize=10;
  fdInit.bTabStopAsSpaces=TRUE;
  fdInit.nUndoLimit=EDIT_UNDOLIMIT;
  fdInit.bDetailedUndo=TRUE;
  ...
  //lpCodepageList=NULL;
  moInit.dwLangCodepageRecognition=1031;
  ...
  moInit.dwKeybLayoutOptions=3;
  //moInit.bSilentCloseEmptyMDI=FALSE;
  //moInit.bDateLog=FALSE;
  moInit.bSaveInReadOnlyMsg=TRUE;
